...
const RaInput = ({
  ...
  return (
    <div className="grid gap-3">
      ...
      <div className={`bg-surface border p-3 rounded-full flex items-center gap-3 focus-within:border-muted/80 focus-within:bg-gray-200 transition-colors duration-300 ${
